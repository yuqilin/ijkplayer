...
IJK_LIB_UPSTREAM=https://github.com/yuqilin/android-ndk-profiler.git
IJK_LIB_FORK=https://github.com/yuqilin/android-ndk-profiler.git
IJK_LIB_COMMIT=qmediaplayer-dev
