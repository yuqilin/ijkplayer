...
# Licensing options:
# modified by zhouhaibo, 2018/04/16
...
# export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-filter=callback"
...
# added by zhouhaibo, For Mediacodec HW Encoder/Decoder
